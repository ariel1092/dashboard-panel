...
export class MongoChatRepository implements ChatRepository {
  ...
  async createChat(): Promise<Chat> {
    ...
    return new Chat(saved._id.toString(), saved.status, saved.specialistId, saved.createdAt, saved.updatedAt)
  }
  ...
  async getChatById(chatId: string): Promise<Chat | null> {
    ...
    return new Chat(doc._id.toString(), doc.status, doc.specialistId, doc.createdAt, doc.updatedAt)
  }

  async getChatsByUserId(userId: string): Promise<Chat[]> {
    // Buscar chats donde el usuario ha enviado mensajes
    ...
    return docs.map((doc) => new Chat(doc._id.toString(), doc.status, doc.specialistId, doc.createdAt, doc.updatedAt))
  }
  ...
  async updateChat(chat: Chat): Promise<Chat> {
    ...
    return new Chat(updated._id.toString(), updated.status, updated.specialistId, updated.createdAt, updated.updatedAt)
  }
